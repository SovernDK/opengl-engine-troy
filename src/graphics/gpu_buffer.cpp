...
void GPUBuffer::initBuffer(size_t maxVertices, size_t maxIndices)
{
    ...
    //Add static/dynamic enum
    glBindBuffer(GL_ARRAY_BUFFER, VBO);
    glBufferData(GL_ARRAY_BUFFER,
        maxVertices * sizeof(Vertex),
        nullptr,
        GL_DYNAMIC_DRAW); // reserve space
    ...
    glVertexAttribPointer(1, 3, GL_FLOAT, GL_FALSE, //color
        sizeof(Vertex),
...
void GPUBuffer::draw(const PrimitiveType type)
{
    switch (type)
    {
